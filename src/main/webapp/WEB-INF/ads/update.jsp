...
<div class="container">
    ...
    <form action="/ads/update" method="post">
        ...
        <div class="form-group">
            <label for="description">Update Description</label>
            <input value="${ad.description}" name="description" class="form-control" type="text">
        </div>
        <div class="form-group">
            <input value="${ad.id}" name="id" class="form-control" style="visibility: hidden" type="text">
        </div>
